...
SecKeyRef gblPublicKey=NULL;
SecKeyRef gblPrivateKey=NULL;
                                                    ...
                                                    error:(BDError *)error
{
    ...
    _secKeyArray = [NSMutableArray array];
    [_secKeyArray addObject:(__bridge id _Nonnull)(publicKey)];
    [_secKeyArray addObject:(__bridge id _Nonnull)(privateKey)];
    if (err != noErr)
    {
...
{
    NSString *identifier = @"-----BEGIN RSA PRIVATE KEY-----  sffdsfsfsfsfsffsf12312313123131sdsfsdfsfsfdsf -----END RSA PRIVATE KEY-----";
...
{
    NSString *identifier = @"-----BEGIN PUBLIC KEY-----  abcdefghijklmnopqrstuvwxyz1234567890wrwrwrwrwrewrer  -----END PUBLIC KEY-----";
